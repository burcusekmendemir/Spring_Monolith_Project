...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> rentACarHandler(RentACarException rentACarException){
        return new ResponseEntity<>(createErrorMessage(rentACarException,rentACarException.getErrorType()),
                rentACarException.getErrorType().getHttpStatus());
    }
